...
selected = option_menu(None, [ "STATUS PREDICTION","PRICE PREDICTION", "ANALYSIS SUMMARY"],
...
if selected == 'ANALYSIS SUMMARY':
    ...
    st.write ("* The copper market is crucial in the electrical and electronics industry due to its high electrical conductivity and thermal conductivity. It is used in wiring, cables, motors, transformers, and generators. The demand for copper is growing due to technological advancements, highlighting the interdependence between electronics manufacturing and the copper market. Higher production levels drive up demand for copper, influencing market dynamics and prices.")
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Umesh Kumar</h6>', unsafe_allow_html=True )
